        ...
        <div className="buttons_container">
          <buttons id="play" className="buttons"  onClick={() =>startTimer()}>
            <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M2.08789 12.9826V1.76447L7.32303 4.62867L12.5582 7.49288L2.08789 12.9826Z" fill="white" stroke="white" strokeWidth="2.99151" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </buttons>
